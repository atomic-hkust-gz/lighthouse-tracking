...
#define TS4231_N1_E_GPIO_PIN 28
// D_Pin P(0,4)
#define TS4231_N1_D_GPIO_PORT 0
#define TS4231_N1_D_GPIO_PIN 3

//sync period output P(0,28)
#define SYNC_OUT_GPIO_PORT 0
#define SYNC_OUT_GPIO_PIN 1

//TS4231 period output P(0,28)
/*#define TS4231_OUT_GPIO_PORT 0
#define TS4231_OUT_GPIO_PIN 2*/
...
//#define TS4231_GPIO_PIN NRF_GPIO_PIN_MAP(TS4231_OUT_GPIO_PORT,TS4231_OUT_GPIO_PIN)
