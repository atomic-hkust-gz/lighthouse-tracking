...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        deviceCountSpin = new QSpinBox(centralWidget);
        deviceCountSpin->setObjectName("deviceCountSpin");
        deviceCountSpin->setGeometry(QRect(70, 530, 42, 25));
        deviceCountSpin->setMinimum(2);
        deviceCountSpin->setMaximum(50);
