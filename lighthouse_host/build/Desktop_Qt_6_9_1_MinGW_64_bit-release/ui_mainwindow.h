...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnAddDevice->setGeometry(QRect(1220, 50, 141, 28));
        btnDelDevice = new QPushButton(centralWidget);
        btnDelDevice->setObjectName("btnDelDevice");
        btnDelDevice->setGeometry(QRect(1220, 80, 141, 28));
        ...
        tableDeviceStatus->setGeometry(QRect(1100, 500, 311, 241));
