/**
 * brief Nordic nrf52833-specific definition of the "radio" bsp module. 
 *
...
void radio_setFrequency(uint8_t frequency, radio_freq_t tx_or_rx) {
    ...
    NRF_RADIO->FREQUENCY = FREQUENCY_STEP*(11-FREQUENCY_OFFSET);
...
void radio_ble_setFrequency(uint8_t channel) {
    ...
    NRF_RADIO->FREQUENCY   = ble_channel_to_frequency(11);
    NRF_RADIO->DATAWHITEIV =11; 
